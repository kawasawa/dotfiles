...
# ファイル変換
# alias pdfzip="(){$_BREW_PREFIX/bin/gs -sDEVICE=pdfwrite -dCompatibilityLevel=1.4 -dPDFSETTINGS=/default -dNOPAUSE -dQUIET -dBATCH -sOutputFile=$2 $1}"  # PDF を圧縮
# alias imgzip='(){convert -quality 80 $1 $2}'                    # 画像を圧縮
