...
alias t='btop'        # システムモニタ TUI
alias g='lazygit'     # Git TUI
alias d='lazydocker'  # Docker TUI
alias k='k9s'         # Kubernetes TUI
