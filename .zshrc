...
alias cmppdf='(){gs -sDEVICE=pdfwrite -dCompatibilityLevel=1.4 -dPDFSETTINGS=/default -dNOPAUSE -dQUIET -dBATCH -sOutputFile=$2 $1}'  # PDFを圧縮
alias cmpimg='(){convert -quality 80 $1 $2}'       # 画像を圧縮
alias img2ico='(){convert -define icon:auto-resize=128 $1 $2}'  # 画像をico形式に変換
